...
export const mockHouses = [
  {
    ...
    shortDescription: 'A Casa Jacatiá é um sobrado de alto padrão em condomínio fechado com segurança 24h, com um hall de entrada de pé-direito duplo de 6 metros e fachada com o mesmo cuidado na frente e nos fundos. São 207 m² distribuídos em 3 quartos (1 suíte com closet) e 4 banheiros, com cozinha americana de ilha, despensa, móveis planejados, cooktop e coifa inclusos. A área gourmet, integrada por amplas esquadrias de vidro, tem piscina, churrasqueira e banheiro completo, com móveis planejados inclusos na área gourmet e em todos os banheiros, além de home office dedicado e 4 vagas de garagem. Tudo executado rigorosamente conforme o conjunto completo de projetos, do arquitetônico à decoração — documentação completa e financiável, com dossiê da obra à disposição, pronta para morar hoje.',
    shortFeatures: [
