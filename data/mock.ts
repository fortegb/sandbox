...
export const mockHouses = [
  {
    ...
    shortDescription: 'A Casa Jacatiá é um sobrado de alto padrão em condomínio fechado com segurança 24h. São 207 m² distribuídos em 3 quartos (1 suíte com closet) e 4 banheiros, com hall de entrada de pé-direito duplo de 6 metros. A cozinha americana com ilha e despensa se abre para a área gourmet, integrada por amplas esquadrias de vidro, com piscina, churrasqueira e banheiro completo — cozinha, área gourmet e banheiros já vêm com móveis planejados, cooktop e coifa inclusos. Um home office dedicado e 4 vagas de garagem completam a casa. Tudo executado rigorosamente conforme o conjunto completo de projetos, do arquitetônico à decoração — documentação completa e financiável, com dossiê da obra à disposição, pronta para morar hoje.',
    shortFeatures: [
    ...
    features: [
      ...
      { text: 'Cozinha americana com ilha, despensa, móveis planejados, cooktop de indução e coifa inclusos', grupo: 'destaque' as const },
      ...
      { text: 'Sistema de aquecimento e pressurização central de água com boiler solar smart Heliotek, controlado por smartphone', grupo: 'destaque' as const },
      { text: 'Fechadura digital premium com vídeo e integração smartphone', grupo: 'destaque' as const },
      { text: 'Persianas eletrônicas smart em todos os dormitórios, compatíveis com assistentes digitais', grupo: 'destaque' as const },
      ...
      { text: 'Projeto de iluminação moderno e elegante em LED, embutido por toda a casa', grupo: 'destaque' as const },
      ...
      { text: 'Rede de gás GLP centralizada, com instalação certificada, seguindo normas técnicas de segurança', grupo: 'engenharia' as const },
