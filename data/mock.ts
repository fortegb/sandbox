...
export const mockHouses = [
  {
    ...
    description: [
      'A Casa Jacatiá é um sobrado de alto padrão em condomínio fechado, com portaria e segurança privada 24 horas e documentação pronta para o financiamento — pronta para morar hoje.',
