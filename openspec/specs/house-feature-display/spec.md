...
Defines how a house's `features` list renders on the portfolio detail page (`pages/portfolio/[slug].vue`), supporting both today's flat checklist and a newer grouped format (Destaques / Diferenciais de Engenharia) without breaking existing houses.
